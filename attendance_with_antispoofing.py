...
def login():
            ...
            if row == None:
                ...
                def manage_employee():
                    try:
                        ...
                        #background_pic.pack()
                        first.config(bg='#FFF2CC')
                        first.title("Manage Employee post")
                        print("Done")
                        face = Label(first, text = "Management of Employee" , bg = '#DFA67B' , fg = "black", padx = 15, pady = 15, font = ("Times New Roman", 20, "bold") ,borderwidth = 5, relief = RIDGE).place(x = 500, y = 10)
                        main = Label(first, bg = "gray", borderwidth = 1).pack()
                        def back():
                            first.destroy() 
                        backbtn = Button(first, text = 'Back', font = ('Times new Roman', 15), fg = 'black', bg = '#DFA67B', height = 1, width = 7, command = back).place(x = 1250, y = 10)  
                            ...
                            if post_var.get() == "" or fname_var.get() == "" or gender_var.get() ==  "" or contact_var.get() == "" or address_var.get() == "":
                                ...
                                if (re.search('[a-zA-Z]+', fname_var.get())):
                                    if len(contact_var.get()) != 10:
                                        ...
                                        if (re.search('^[0-9]\d{9}$', contact_var.get())):
                                            regex = '^(\w|\.|\_|\-)+[@](\w|\_|\-|\.)+[.]\w{2,3}$'
                    ...
                    ################################################## Employee Management form ###############################
                        f2 = Frame(first, bg = '#DFA67B',borderwidth = "3", relief = SUNKEN, height = 600, width = 420)
                        titles = Label(f2, text = "Manage Employee" ,bg = '#DFA67B', font = ("Italic", 20, "bold")).place(x = 90, y = 30)
                        id = Label(f2, text = "Employee ID", bg = '#DFA67B', font = ("italic",13, "bold")).place(x = 35, y = 100 )
                        E1 = Entry(f2,state="disabled", width = 20, textvariable = eid_var,  font = ("italic",13, "bold") ).place(x = 180  , y = 100)
                        post = Label(f2, text = "Post", bg = '#DFA67B',  font = ("italic",13, "bold")).place(x = 35, y = 150 )
                        E2 = Entry(f2, width = 20, textvariable = post_var,  font = ("italic",13, "bold")).place(x =180, y = 150)
                        name = Label(f2, text = "Full Name", bg = '#DFA67B', font = ("italic",13, "bold")).place(x =35, y = 200)
                        E3 = Entry(f2, width = 20, textvariable = fname_var , font = ("italic",12, "bold")).place(x = 180, y = 200)
                        gender = Label(f2, text = "Gender", bg = '#DFA67B', font = ("italic",12, "bold")).place(x = 35, y= 250)
                        E7 = Combobox(f2, textvariable = gender_var , values = ["Male","Female","Others"], state = "readonly",  font = ("italic",11, "bold")).place(x = 180, y = 250)
                        no = Label(f2, text = "Contact.No", bg = '#DFA67B', font = ("italic",12, "bold")  ).place(x = 35, y = 300)
                        E4 = Entry(f2, width = 20, textvariable = contact_var , font = ("italic",12, "bold") ).place(x = 180, y = 300 ) 
                        address = Label(f2, text = " Email Address", bg = '#DFA67B', font = ("italic",12, "bold")).place(x = 35, y = 350)
                        ...
                        btn1 = Button(f3, text = "Add", bg = '#DFA67B', height = "1", width = "7",command = add_employee, font = ("Times new Roman", 14 , "bold")).place(x = 10, y = 10)
                        btn2 = Button(f3, text = "Update", bg = '#DFA67B', height = "1", width = "7", command = update, font = ("Times new Roman", 14 , "bold")).place(x = 105, y = 10)
                        btn3 = Button(f3, text = "Delete", bg = '#DFA67B',  height = "1", width = "7", command = delete,  font = ("Times new Roman", 14 , "bold")).place(x = 205, y = 10)
                        btn4 = Button(f3, text = "Clear", bg = '#DFA67B', height = "1", width = "7", command = clear, font = ("Times new Roman", 14 , "bold")).place(x = 305, y = 10)
                        ...
                        f3.place(x = 20, y = 550)
                    ################################################################################### Large Frame
                        f4 = Frame(first, height = 600, width = 900, bg = '#FFF2CC', borderwidth = "3", relief = SUNKEN)
                        f4.place(x = 440, y = 90)
                        l1 = Label(first, text = "Search By:",font = ("times new roman", 18 ,"bold"),bg = '#DFA67B', fg = "black").place(x = 460, y = 100 )
                        ...
                        btn7 = Button(first,  text = "Search ", bg = '#DFA67B', height = "1", width = "16", command = search_data, font = ("Times new Roman", 13 , "bold")).place(x = 960, y = 100 )
                        btn8 = Button(first, text = "Show All", bg = '#DFA67B', height = "1", width = "16", command = show_data, font = ("Times new Roman", 13 , "bold")).place(x = 1150, y = 100)
                    ################################################################################## Table frame
                ...
                def train(): 
                    try:
                        ...
                        #backgrd.pack()
                        second.config(bg='#F5EBEB')
                        second.geometry("1400x700+0+0")
                        train_title = Label(second, text = "Train the System", fg = "black", font = ("times new roman", 20, "bold"), bg = '#DFA67B')
                        ...
                        def back():
                            second.destroy()   
                        backbtn = Button(second, text = 'Back', fg = "black", bg = '#DFA67B', font = ('Times new roman', 15), height = 1, width = 7, command = back).place(x = 1260, y = 3)
                        ...
                        btn = Button(second, text = "Start Training", fg = "black",font = ("Times new roman", 20, "bold"), command = progress, bg = '#DFA67B' )
    ...
    ######################################### Function to recognize the face
                ...
                def change():
                    ...
                    title = Label(account_frame, text = "Admin Account", font = ('times new roman', 20, 'bold')  , bg = '#DFA67B', bd = 3, relief = SUNKEN)    
                    ...
                    newpass_var = StringVar()
                    backbtn = Button(account, text = 'Back' , bg = '#DFA67B', fg = "black",font = ("Times New Roman", 13, "bold") ,borderwidth = 1, relief = RIDGE, command = back).place(x = 445, y = 7)
                    ...
                    btn = Button(account_frame, text = 'Reset', font = ('times new roman', 14, 'bold'), width = 10 , bg = '#DFA67B',  command = user_change, relief = GROOVE).place(x = 240, y = 380 )
                    account.mainloop()   
                ...
                def report():
                    ...
                    report.config(bg = '#FFF2CC')
                    title = Frame(report, bg = '#FFF2CC', bd = "3", relief = SUNKEN )
                    title.pack(fill = BOTH)
                    title_label = Label(title, text = "Attendance Report", font = ("times new roman", 30, "bold"), fg = "black", bg = '#DFA67B')
                    title_label.pack()
                    def back():
                        report.destroy()
                    backbtn = Button(title, text = 'Back' , bg = '#DFA67B', fg = "black", font = ("Times New Roman", 20 ,"bold"), relief = RIDGE, command = back).place(x = 1250, y = 0)
                    ...
                    search_text = StringVar()
                    ####################################### Textfill Frame 
                    text_fill = Frame(report, height = 620, width = 1350, bg= '#FFF2CC', borderwidth = "3", relief = SUNKEN)
                    text_fill.place(x = 10, y = 75)
                    search_label = Label(text_fill, text = "Search By:", font = ("times new roman", 15, "bold"), bg = '#FFF2CC')
                ...
                #bg_image = PhotoImage(file = "Photos/kirti.png", master = attendance)
                #background_photo = Label(attendance, image = bg_image)
                #background_photo.pack()
                attendance.config(bg='#F5EBEB')
                ...
                topic = Label(attendance, text = manage , bg = '#DFA67B' , fg = "black", padx = 15, pady = 15, font = ("Times New Roman", 20, "bold") ,borderwidth = 5, relief = RIDGE)
...
title = Label(face, text = "Admin Login Page" , font = ("times new roman", 30, "bold"), bg = '#DFA67B', fg = "black", bd = 7, relief = GROOVE) 
title.place(x = 0, y = 0, relwidth = 1)

clock = Label(face , font = ("times",20,"bold"), bg = '#DFA67B', relief = GROOVE)
clock.place(x = 1000, y= 600)
tick()
login_frame= Frame(face, bg = '#FFF2CC' )
...
user_label = Label(login_frame , text = "Username", image = user_icon, bg= '#FFF2CC', compound = LEFT, font = ("times new roman", 15, "bold")).grid( row  = 1 , column = 0, padx = 30, pady = 5)
...
password_label = Label(login_frame, text = "Password", image = password_icon, bg ='#FFF2CC', compound = LEFT, font = ("times new roman", 15, "bold")).grid(row = 2, column = 0, padx = 30, pady = 5)
...
submit_btn = Button(login_frame, text = "Log In",width = 10, activebackground = "#FFF2CC", activeforeground = "white", command = login , font = ("times new roman", 20, "bold"),relief = GROOVE, bg = '#DFA67B').grid(row = 3, column = 1, pady =25, padx = 25) 
face.mainloop()            